  ...
  theme: {
    extend: {
      colors: {
        ...
        'premium-vip': 'hsl(var(--premium-vip))',
      ...
      backgroundImage: {
        ...
        'tech-grid': 'linear-gradient(rgba(0, 243, 255, 0.08) 1px, transparent 1px), linear-gradient(90deg, rgba(0, 243, 255, 0.08) 1px, transparent 1px)',
      ...
      keyframes: {
        ...
        premiumGlow: {
          '0%, 100%': { 
            boxShadow: '0 0 20px hsl(var(--premium-gold) / 0.3)' 
          },
          '50%': { 
            boxShadow: '0 0 40px hsl(var(--premium-gold) / 0.6)' 
          },
        },
        shimmer: {
